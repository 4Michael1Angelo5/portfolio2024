...
export const projectsInfo= [
    {
        ...
        image:   sangaku13 ,
        projectOverview: [
            {title:"The Problem", image:SQ , description: "Given a curve y = cos(x) \
            ...
            {title:"Finding a Solution", image:  pedaltrianle , description:"I began by first considering the idea of \
            ...
            {title:"Assumptions", image: PAbsect, description: "One vertice of the pedal triangle would have to exist at the point (t, cos(t)). \
            ...
            {title:"Distance Formula", image: parobla, description: "The distance from the center of next circle to the center of previous circle minus the radial length of the previous \
            circle must to be equivilent to radial length of the next circle."} ,
            {title:"", image: sangaku13 , description: " These three realization helped me come up with a system of three equation that eventually helped me find a satisfactuary \
    ...
    },
    {
        ...
        projectOverview: [
            {title:"What is a Magic Cube", image: PerfectMagicCube5_850, 
            description: "A magic cube of order N, is a 3-dimensional matrix of \
            ...
            {title:"5 x 5 Perfect Magic Cube", image:PerfectMagicCube5Slices_850 , description: "In the example below the sum of each row column \
            ...
            {title:" Magic Cube's Sums", image:  PerfectMagicCubeLines_950, description: "The lines below show the directions in which \
            the numbers can be summed that will all equal the same number, the Magic Constant."} ,  
            {title:"Note Book Page", image:  notebook, description: " This is what my notebook looked like when trying to find a pattern \
